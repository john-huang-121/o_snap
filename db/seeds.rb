...
h.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'editor_uploads','erik-mclean-1105987-unsplash.jpg')), filename: 'panda_party.jpg')
h.save!
...
i.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'daniel-monteiro-1105874-unsplash.jpg')), filename: 'styling_girl.jpg')
i.save!
...
j.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'dasha-yukhymyuk-1104765-unsplash.jpg')), filename: 'shadow_art.jpg')
j.save!
...
k.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'hunter-newton-1104673-unsplash.jpg')), filename: 'girl_at_the_fair.jpg')
k.save!
...
l.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'jeff-kepler-1106964-unsplash.jpg')), filename: 'wild_girl.jpg')
l.save!
...
m.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'lee-cartledge-1107548-unsplash.jpg')), filename: 'girl_and_green_chair.jpg')
m.save!
...
n.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 's-a-r-a-h-s-h-a-r-p-1104810-unsplash.jpg')), filename: 'couple_in_orchard.jpg')
n.save!

o = Picture.new({title:'Grass Upclose', description:'Camera focused on the grass.', user_id: 4, tags: ['grass','green']})
o.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'aaron-burden-266395-unsplash.jpg')), filename: 'grass.jpg')
o.save!
...
p.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'alan-emery-121147-unsplash.jpg')), filename: 'flamingo.jpg')
p.save!
...
q.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'amanda-phung-1281331-unsplash.jpg')), filename: 'landscape.jpg')
q.save!

r = Picture.new({title:'City Skyline', description:'Great view of the city near dusk', user_id: 6, tags: ['city', 'dusk', 'lights']})
r.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'andreas-brucker-630339-unsplash.jpg')), filename: 'city_skyline.jpg')
r.save!
...
s.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'annie-spratt-42459-unsplash.jpg')), filename: 'succulent.jpg')
s.save!
...
t.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'anton-darius-thesollers-424266-unsplash.jpg')), filename: 'gold_leaves.jpg')
t.save!

u = Picture.new({title:'The City', description:'A great view of the city', user_id: 5, tags: ['city']})
u.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'ben-o-bro-170472-unsplash.jpg')), filename: 'another_city.jpg')
u.save!
...
v.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'blake-richard-verdoorn-20063-unsplash.jpg')), filename: 'multinomah_falls.jpg')
v.save!
...
w.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'boris-smokrovic-146294-unsplash.jpg')), filename: 'butterfly.jpg')
w.save!

x = Picture.new({title:'It\'s for my account', description:'yay!', user_id: 5, tags: ['person','people']})
x.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'brooke-cagle-274465-unsplash.jpg')), filename: 'a_man.jpg')
x.save!

y = Picture.new({title:'Redwoods', description:'John Muir Forest', user_id: 6, tags: ['nature']})
y.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'casey-horner-487085-unsplash.jpg')), filename: 'nature_2.jpg')
y.save!

z = Picture.new({title:'Blue Bird', description:'A blue parakeet? Not sure, but it\'s cool!', user_id: 7, tags: ['bird','animal','blue']})
z.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'dominik-lange-41372-unsplash.jpg')), filename: 'bird.jpg')
z.save!

aa = Picture.new({title:'Golden Sunset', description:'Sunset Beach 2019', user_id: 5, tags: ['beach','gold','sunset','nature']})
aa.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'frank-mckenna-140054-unsplash.jpg')), filename: 'sunset.jpg')
aa.save!
...
ab.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'jc-gellidon-565177-unsplash.jpg')), filename: 'building_lights.jpg')
ab.save!

ac = Picture.new({title:'Yes Sir Cheetah', description:'A cute baby cheetah doing it\'s salute.', user_id: 7, tags: ['animal','cheetah']})
ac.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'jean-wimmerlin-528108-unsplash.jpg')), filename: 'cheetah.jpg')
ac.save!

ad = Picture.new({title:'Koala', description:'Koala taking an afternoon nap.', user_id: 7, tags: ['animal','koala','nap']})
ad.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'jordan-whitt-78672-unsplash.jpg')), filename: 'koala.jpg')
ad.save!

ae = Picture.new({title:'Young Buck', description:'I think I startled him while he was grazing.', user_id: 7, tags: ['deer','animal']})
ae.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'laura-college-190105-unsplash.jpg')), filename: 'deer.jpg')
ae.save!
...
af.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'linnea-sandbakk-91258-unsplash.jpg')), filename: 'fox.jpg')
af.save!

ag = Picture.new({title:'Foggy Hills', description:'Fog rolling over the hills', user_id: 4, tags: ['fog','nature']})
ag.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'luca-zanon-26595-unsplash.jpg')), filename: 'fog_hills.jpg')
ag.save!
...
ah.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'max-bender-572807-unsplash.jpg')), filename: 'city_street_2.jpg')
ah.save!

ai = Picture.new({title:'NASA Aerial', description:'Top down... FROM SPACE', user_id: 2, tags: ['NASA','space','city']})
ai.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'nasa-43569-unsplash.jpg')), filename: 'nasa.jpg')
ai.save!

aj = Picture.new({title:'Big Tree', description:'A very large tree.', user_id: 5, tags: ['nature','tree','big']})
aj.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'niko-photos-333391-unsplash.jpg')), filename: 'tree.jpg')
aj.save!

ak = Picture.new({title:'Squirrel', description:'Fed it a snack so I can take this picture', user_id: 7, tags: ['squirrel','animal']})
ak.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'radoslaw-prekurat-148700-unsplash.jpg')), filename: 'squirrel.jpg')
ak.save!
...
al.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'riccardo-chiarini-365677-unsplash.jpg')), filename: 'perfect_landscape.jpg')
al.save!

am = Picture.new({title:'Adorbs Lamb', description:'This fluffy guy walked right up to me for this.', user_id: 7, tags: ['lamb','animal']})
am.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'sam-carter-191161-unsplash.jpg')), filename: 'lamb.jpg')
am.save!

an = Picture.new({title:'White Tiger', description:'Found this guy in a zoo.', user_id: 7, tags: ['tiger','animal']})
an.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'smit-patel-344842-unsplash.jpg')), filename: 'tiger.jpg')
an.save!

ao = Picture.new({title:'Skyscrapers', description:'Woah, so tall', user_id: 5, tags: ['tall','city']})
ao.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'tyler-nix-574395-unsplash.jpg')), filename: 'skyscraper.jpg')
ao.save!

aq = Picture.new({title:'Purple Ocean', description:'In a sea of violet.', user_id: 1, tags: ['ocean','purple', 'shore', 'rocks', 'boulder']})
aq.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'editor_uploads','brett-ritchie-567662-unsplash.jpg')), filename: 'ocean.jpg')
aq.save!
...
ar.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'editor_uploads','guillaume-tourette-1107283-unsplash.jpg')), filename: 'snow_cabin.jpg')
ar.save!
...
as.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'gautier-salles-1106358-unsplash.jpg')), filename: 'cliff.jpg')
as.save!
...
at.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'marlon-martinez-1105823-unsplash.jpg')), filename: 'mountain_and_lake.jpg')
at.save!
...
av.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'user_uploads', 'nathan-dumlao-1105826-unsplash.jpg')), filename: 'beach_feet.jpg')
av.save!
...
ax.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'annie-spratt-210740-unsplash.jpg')), filename: 'wedding_flowers.jpg')
ax.save!
...
ay.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'charl-van-rooy-672182-unsplash.jpg')), filename: 'forest.jpg')
ay.save!

aaa = Picture.new({title: 'Modern', description: 'Chic, stylish, upscale.', user_id: 2, tags: ['tan','lounge']})
aaa.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'daniil-silantev-574958-unsplash.jpg')), filename: 'swing_bed.jpg')
aaa.save!

aab = Picture.new({title: 'Colorful Foods', description: 'So many colors in this delicious bowl.', user_id: 2, tags: ['color','food','art']})
aab.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'edgar-castrejon-459822-unsplash.jpg')), filename: 'color_food.jpg')
aab.save!
...
aac.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'indra-sebeloue-1386674-unsplash.jpg')), filename: 'breakfast.jpg')
aac.save!

aad = Picture.new({title: 'Street View', description: 'A great view of the city street.', user_id: 2, tags: ['street','city']})
aad.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'josh-connor-1386487-unsplash.jpg')), filename: 'street.jpg')
aad.save!
...
aae.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'sacha-styles-552126-unsplash.jpg')), filename: 'beach.jpg')
aae.save!

aaf = Picture.new({title: 'A la Playa', description: 'Beach dayyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy :)', user_id: 2, tags: ['beach','sand']})
aaf.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'sergio-souza-1386788-unsplash.jpg')), filename: 'playa.jpg')
aaf.save!
...
aag.picture.attach(io: File.open(Rails.root.join('db', 'seeds', 'demo_user_uploads', 'sid-verma-1387708-unsplash.jpg')), filename: 'tundra.jpg')
aag.save!
